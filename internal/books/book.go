...
func NewBookFactory(title string, publisher *publisher.Publisher, pages int, language string, edition int, year int, isbn string,
...
func ValidateBook(title string, publisher *publisher.Publisher, pages int, language string, edition int, year int,
